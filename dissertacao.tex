...
%\input{parts/case_study/filling_station_advisor}

\chapter{Background}
\label{chap:background}

\input{parts/background/_background}
...
\chapter{The Goalp Approach}
\label{chap:proposal}
\input{parts/_offline}
\input{parts/_online}
