...
\begin{abstract}\textbf{}
  ...
  In recent years we see a growing availability of devices with computer capabilities. With this come an opportunity for applications that use a number of heterogeneous computer units in dynamic environments. That environments have a high level of uncertainty from the point of view of the system designer.
