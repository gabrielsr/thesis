...
\input{parts/background/mas}
\input{parts/background/dependability}
%\input{background/self_adaptability}
...
\input{parts/related/related}

\chapter{Proposal}
\input{parts/proposal/_proposal}
